        ...
        <div className="container mx-auto px-30 pt-60 pb-10 h-40 flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 flex flex-col gap-6">
            ...
            <div className="flex gap-4">
              <a href="#" className="bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded-full transition pulse">Start Now</a>
              <a href="#" className="border-2 border-white px-6 py-3 rounded-full hover:bg-white hover:text-indigo-900 transition">Learn More</a>
            </div>
          </div>
