(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_68e96a1f._.js", {
...
function RoomPage({ onRoomCreated }) {
    ...
    const [userRooms, setUserRooms] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [joiningRoom, setJoiningRoom] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
                        ...
                        if (res.ok) {
                            ...
                            if (data.user?.id) {
                                ...
                                const [userRoomsData, publicRoomsData] = await Promise.all([
                                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rooms$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUserRooms"])(userData.id),
                                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rooms$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPublicRooms"])()
                                ]);
                                setUserRooms(userRoomsData);
                                setPublicRooms(publicRoomsData.filter({
                                    "RoomPage.useEffect.getSessionInfo": (room)=>room.creatorId !== userData.id
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RoomPage.useEffect": ()=>{
            ...
            const roomId = `${roomName.toLowerCase().replace(/\s+/g, "-")}-${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uuid$2f$dist$2f$esm$2d$browser$2f$v4$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__v4$3e$__["v4"])().substring(0, 8)}`;
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            const roomId = `${roomName.toLowerCase().replace(/\s+/g, "-")}-${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uuid$2f$dist$2f$esm$2d$browser$2f$v4$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__v4$3e$__["v4"])().substring(0, 8)}`;
            const newRoomId = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rooms$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createRoom"])({
                id: roomId,
                name: roomName,
                objective,
                visibility,
    ...
    const handleJoinRoom = async ()=>{
        ...
        try {
            ...
            const roomExists = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rooms$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["checkRoomExists"])(roomIdToJoin);
            if (!roomExists) {
            ...
            const success = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rooms$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["joinRoom"])(roomIdToJoin, user.id, user.email, user.name);
            if (success) {
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                                                    ...
                                                                    children: [
                                                                        ...
                                                                        userRooms.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("optgroup", {
                                                                            label: "Your Rooms",
                                                                            children: userRooms.map((room)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                                                    value: room.id,
                                                                                    children: [
                                                                                        room.name,
                                                                                        " (",
                                                                        ...
                                                                        publicRooms.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("optgroup", {
                                                                            label: "Public Rooms",
                                                                            children: publicRooms.map((room)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                                                    value: room.id,
                                                                                    children: [
                                                                                        room.name,
                                                                                        " - by ",
                                                                ...
                                                                allAvailableRooms.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s(RoomPage, "tRkKg0w6J442c3YG4qqQtmPmRsw=", false, function() {
    return [
...
function MeetingInterface({ roomId }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MeetingInterface.useEffect": ()=>{
            const initializeSession = {
                "MeetingInterface.useEffect.initializeSession": async ()=>{
                    try {
                        // Get user session
                        const res = await fetch("/api/session");
                        const data = await res.json();
                        ...
                        const roomData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rooms$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["checkRoomExists"])(roomId);
                        if (!roomData) {
            ...
            }["MeetingInterface.useEffect.initializeSession"];
            initializeSession();
        }
    }["MeetingInterface.useEffect"], [
        roomId
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MeetingInterface.useEffect": ()=>{
            const manageStream = {
                "MeetingInterface.useEffect.manageStream": async ()=>{
                    if (!isMicOn && !isCameraOn) {
                        if (streamRef.current) {
                            streamRef.current.getTracks().forEach({
                                "MeetingInterface.useEffect.manageStream": (track)=>track.stop()
                            }["MeetingInterface.useEffect.manageStream"]);
                            streamRef.current = null;
            ...
            return ({
                "MeetingInterface.useEffect": ()=>{
                    if (streamRef.current) {
                        streamRef.current.getTracks().forEach({
                            "MeetingInterface.useEffect": (track)=>track.stop()
                        }["MeetingInterface.useEffect"]);
                    }
                }
            })["MeetingInterface.useEffect"];
    ...
    const joinRoomHandler = async (userData)=>{
        ...
        setJoining(true);
        try {
            const success = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rooms$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["joinRoom"])(roomId, userData.id, userData.email, userData.name);
            if (!success) {
    ...
    const leaveRoomHandler = async ()=>{
        try {
            if (user) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rooms$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["leaveRoom"])(roomId, user.id);
            }
    ...
    const handleSendMessage = async ()=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$rooms$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sendMessage"])(roomId, input, user.id, user.name);
            setInput("");
        } catch (error) {
            console.error("Error sending message:", error);
        }
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$components$2f$AnimatePresence$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AnimatePresence"], {
                            ...
                            children: activeTab === "chat" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                                ...
                                children: [
                                    ...
                                    participants.length ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "space-y-2",
                                        children: participants.map((p, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(MeetingInterface, "ybhrAn3wV3njEraymJERZArM0b8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
...
//# sourceMappingURL=src_68e96a1f._.js.map