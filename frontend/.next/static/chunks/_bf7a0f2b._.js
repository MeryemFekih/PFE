(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_bf7a0f2b._.js", {
...
const CoworkingRoom = ()=>{
    _s();
    const [roomId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(uuidv4());
    ...
    const [localVideoTrack, setLocalVideoTrack] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CoworkingRoom.useEffect": ()=>{
            const initAgora = {
                "CoworkingRoom.useEffect.initAgora": async ()=>{
                    const AgoraRTC = (await __turbopack_context__.r("[project]/node_modules/agora-rtc-sdk-ng/AgoraRTC_N-production.js [app-client] (ecmascript, async loader)")(__turbopack_context__.i)).default;
                    const agoraClient = AgoraRTC.createClient({
                        mode: 'rtc',
                        codec: 'vp8'
                    });
                    setClient(agoraClient);
                    const tokenRes = await fetch(`/api/agora-token?channelName=${roomId}`);
                    const { token } = await tokenRes.json();
                    await agoraClient.join(APP_ID, roomId, token, null);
            ...
            }["CoworkingRoom.useEffect.initAgora"];
            initAgora();
            return ({
                "CoworkingRoom.useEffect": ()=>{
                    if (client) {
...
_s(CoworkingRoom, "vrSntBEAoN6q2N+fh9YHK0KnEQI=");
_c2 = CoworkingRoom;
...
__turbopack_context__.k.register(_c2, "CoworkingRoom");
...
//# sourceMappingURL=_bf7a0f2b._.js.map