(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_870cc10f._.js", {
...
function ClientPostFormFeed({ user }) {
    _s();
    const { title, setTitle, content, setContent, media, setMedia, mediaPreview, setMediaPreview, type, setType, visibility, setVisibility, eventType, setEventType, subject, setSubject, customSubject, setCustomSubject, showCustomSubject, setShowCustomSubject, startDate, setStartDate, location, setLocation, speakerId, setSpeakerId, fileInputRef, handleSubmit, resetForm } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$usePostFormLogic$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePostFormLogic"])();
...
_s(ClientPostFormFeed, "kFSdvjIaKW6r1tzgXjyxweZ1aBg=", false, function() {
    return [
        ...
        "SuggestedEventList.useEffect": ()=>{
            const loadSuggestedEvents = {
                "SuggestedEventList.useEffect.loadSuggestedEvents": async ()=>{
                    ...
                    try {
                        const suggested = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$post$2d$action$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSuggestedEvents"])(); // ✅ No userId param needed
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            onClick: async ()=>{
                                setIsAdding(true);
                                try {
                                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$event$2d$action$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["addPostEventToPlanner"])(selectedEvent); // ✅ pass full event
...
function FacultyFeedPage({ posts, session }) {
    ...
    const pickerRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const [hoveredUserId, setHoveredUserId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FacultyFeedPage.useEffect": ()=>{
            const loadSuggestions = {
                "FacultyFeedPage.useEffect.loadSuggestions": async ()=>{
                    if (!session?.user?.id) {
                        setIsLoading(false);
                        return;
                    }
                    try {
                        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$post$2d$action$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSuggestedEvents"])();
                        setSuggestedPosts({
            ...
            }["FacultyFeedPage.useEffect.loadSuggestions"];
            loadSuggestions();
        }
    }["FacultyFeedPage.useEffect"], [
        session?.user?.id
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FacultyFeedPage.useEffect": ()=>{
            const loadSuggestedUsers = {
                "FacultyFeedPage.useEffect.loadSuggestedUsers": async ()=>{
                    try {
                        const users = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$user$2d$action$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSuggestedUsers"])();
                        const facultyUsers = users.filter({
                            "FacultyFeedPage.useEffect.loadSuggestedUsers.facultyUsers": (user)=>[
                                    'STUDENT',
                                    'ALUMNI',
                                    'PROFESSOR'
                                ].includes(user.role)
                        }["FacultyFeedPage.useEffect.loadSuggestedUsers.facultyUsers"]);
                        setSuggestedUsers(facultyUsers);
                    } catch (err) {
                        console.error('Error loading suggested users:', err);
                    }
                }
            }["FacultyFeedPage.useEffect.loadSuggestedUsers"];
            loadSuggestedUsers();
        }
    }["FacultyFeedPage.useEffect"], []);
    const ALLOWED_ROLES = [
...
//# sourceMappingURL=src_870cc10f._.js.map