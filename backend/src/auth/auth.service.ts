 ...
 async login(userId: number, email: string, firstName: string, role: Role) {
  ...
  return {
    user: {
      ...
      role: fullUser.role,
      interests: Array.isArray(fullUser.interests) ? fullUser.interests : [],
      university: fullUser.university,
      formation: fullUser.formation,
      subject: fullUser.subject,
    },
    accessToken,
    refreshToken,
  };
  ...
  async validateJwtUser(userId: number) {
    ...
    const currentUser: CurrentUser = {
      ...
      graduationYear: user.graduationYear?.toISOString() || null,
      degree: user.degree,
